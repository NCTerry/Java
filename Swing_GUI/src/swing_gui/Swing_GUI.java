...
&&
https://www.newthinktank.com/2012/03/java-video-tutorial-23/

We created a GUI with:
    A place to enter 2 different numbers
        If the user input cannot be converted to doubles you will get an error.

    A selection for dollars or commas
        If dollars is selected, the result will be in money
        If commas is selected, the result will just be a number

    A place for 4 math selections are available
        These are normal and if one is checked, it will use the function we created 
...
//------------------------------------------------------
    ...
    public static void main(String[] args){
            ...
            new Swing_GUI(); //create frame by calling constructor
...
//------------------------------------------------------
    ...
    public Swing_GUI(){
            ...
            // null means auto center of screen
    ...
    private class ListenForButton implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e){
            ...
            if(e.getSource() == button1){//-----------------
                ...
                // We are turning what is in the text field into a double
                try{
                    ...
                    // If the input text is not able to convert into a number
                    // It will spit an error message and close the GUI
                    // (parentComponent, message, title, error icon)
                    // Error Icons: WARNING_MESSAGE, QUESTION_MESSAGE, PLAIN_MESSAGE
                    JOptionPane.showMessageDialog(Swing_GUI.this, "Please Enter the Right Info", "Error", JOptionPane.ERROR_MESSAGE);
                    System.exit(0); // Closes the Java app
                }
                
//------------------------------------------------------
//------------------------------------------------------
                // We make it here if the user input can be converted to a double
                if(addNums.isSelected()) { //-----------------
                    // totalCalc grabs numbers from both inputs
                    // It uses a built-in function to add them together.
                    // Sends 3 parameters to function we created below. 
                    // Function for each possible selection.
                ...
                if(dollarSign.isSelected()) {//-----------------
                    ...
                    JOptionPane.showMessageDialog(Swing_GUI.this, numFormat.format(totalCalc), "Solution", JOptionPane.INFORMATION_MESSAGE);
                } 
//-----------------
//-----------------
                // If the comma is selected in the checkbox print the number with commas
                    ...
                    JOptionPane.showMessageDialog(Swing_GUI.this, totalCalc, "Solution", JOptionPane.INFORMATION_MESSAGE);
                }
            }
        }
    }
