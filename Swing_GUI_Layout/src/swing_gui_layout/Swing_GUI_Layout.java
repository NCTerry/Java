/*
http://www.newthinktank.com/2012/03/java-video-tutorial-28/

In this part of my Java Video Tutorial, I cover 3 different Swing layout managers. 
I revisit the the layout manager we have been using by default being Flow Layout. 
As well I introduce the Border and Box layout managers.

I answer many common questions like how do you get to components in a Border frame quadrant? 
How do I add space between components and much more.


NOTE: There are quite a few different commented options here
I have played around with a few, but you can only display s many. 

 */
package swing_gui_layout;
...
public class Swing_GUI_Layout extends JFrame{
	...
	public static void main(String[] args){
		...
		new Swing_GUI_Layout();
		
	}
	
	public Swing_GUI_Layout(){
