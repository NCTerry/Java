/*
http://www.newthinktank.com/2012/04/java-video-tutorial-33/

Here I continue covering everything about Java. 
Today I completely cover reading and writing Java Binary Streams.

Binary streams read and write using different methods 
...
//*************************************	
	public static void main(String[] args){
            ...
            DataOutputStream custOutput = createFile("/Users/Tracksta6/Dropbox/Computer Science/Java/BinaryStreams/src/customers.dat");
...
//*************************************        
	...
	private static DataOutputStream createFile(String fileName){
            ...
            try{
                ...
                // FileOutputStream(listOfNames, false))); --> Would auto-create a new file
                // FileOutputStream(listOfNames, true))); --> Would auto-append to a current file
                
                // Send back the ability to write to file.
                return infoToWrite;
            }
            ...
            //This method expects a return type, so we must include a null.
            return null;
...
//*************************************	
	...
	private static void getFileInfo(){
            ...
            File listOfNames = new File("/Users/Tracksta6/Dropbox/Computer Science/Java/BinaryStreams/src/customers.dat");
