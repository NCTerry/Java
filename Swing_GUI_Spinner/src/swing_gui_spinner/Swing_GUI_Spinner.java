/*
http://www.newthinktank.com/2012/03/java-video-tutorial-26/

In this part of the Java Video Tutorial, I focus on the Java Swing JSpinner component. 
I’ll show you how to cycle through numbers, dates and just about anything else. 
I also revisit the Dimension, Date and Calendar libraries.

Most Java Tutorials gloss over topics like this, but I decided I wanted to 
    create a truly comprehensive tutorial.
 */
package swing_gui_spinner;
...
public class Swing_GUI_Spinner extends JFrame{
...
//**************************************
    public static void main(String[] args){
        ...
        new Swing_GUI_Spinner();

    }
//**************************************
    public Swing_GUI_Spinner(){
    ...
    private class ListenForButton implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e){
            ...
            if(e.getSource() == button1){
                ...
                JOptionPane.showMessageDialog(Swing_GUI_Spinner.this, outputString, "Information", JOptionPane.INFORMATION_MESSAGE);
