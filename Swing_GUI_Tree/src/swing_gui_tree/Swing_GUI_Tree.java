/*
http://www.newthinktank.com/2012/03/java-video-tutorial-27/
...
//****************************************
public class Swing_GUI_Tree extends JFrame{
...
//****************************************
    public Swing_GUI_Tree(){
        ...
        // Only show 12 rows of the tree at a time
        theTree.setVisibleRowCount(12);
...
//****************************************
                ...
                JOptionPane.showMessageDialog(Swing_GUI_Tree.this, outputString, "Information", JOptionPane.INFORMATION_MESSAGE);
